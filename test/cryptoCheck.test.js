...
describe('crypto_check', function () {
  ...
  it('must check correct signature', async() => {
    ...
    const signature = "0xc9533d4ec47a18ad0f98e910269b6492635c606010c9481c120bfa3552b80238173597765e17b2" +
    ...
    `
    const result = await invokeTest({parameter: params, contractPath: "test/contracts/crypto_check.ligo", entryPoint: "main", initialStorage: "False"})
  })
})
